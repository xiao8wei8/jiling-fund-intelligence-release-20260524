...
【重要合规要求】
以下是必须严格遵守的金融营销合规要求，请务必在生成文案时遵循：
1. 绝对禁止使用以下禁用词汇：保本、保证收益、零风险、稳赚不赔、高收益无风险、只赚不赔、收益保底、无风险、最低收益、最高收益、确定收益等保证收益或无风险的词汇
2. 禁止承诺收益或夸大收益描述
3. 禁止虚假宣传或夸大宣传
4. 必须在文案中明确包含风险提示内容，例如"基金有风险，投资需谨慎"或类似表述
5. 描述业绩时需注明数据来源和时间范围（如适用）
6. 保持客观、真实、准确的表述风格
7. 禁止使用绝对化表述（如"最好"、"第一"、"唯一"等，除非有权威数据支持）

请在生成文案时主动遵守以上合规要求，确保生成的文案合规性良好。"""
...
【重要合规要求】
以下是必须严格遵守的金融营销合规要求，请务必在修改文案时遵循：
1. 绝对禁止使用以下禁用词汇：保本、保证收益、零风险、稳赚不赔、高收益无风险、只赚不赔、收益保底、无风险、最低收益、最高收益、确定收益等保证收益或无风险的词汇
2. 禁止承诺收益或夸大收益描述
3. 禁止虚假宣传或夸大宣传
4. 必须在文案中明确包含风险提示内容，例如"基金有风险，投资需谨慎"或类似表述
...
请在修改文案时主动遵守以上合规要求，确保修改后的文案合规性良好。"""
